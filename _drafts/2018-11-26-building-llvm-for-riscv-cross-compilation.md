...
TODO: Explain why you need to get the GNU Toolchain.

[More information here.](https://github.com/riscv/riscv-gnu-toolchain#installation-linux)
...
If you'd prefer a simple go/no-go test on the build, instead of running the time-expensive `check-all` target in the last step, inspect the return value (`echo $?`) for a value of `0`.
