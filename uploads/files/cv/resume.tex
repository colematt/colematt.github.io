...
\name{Matthew R. Cole}
\address{
	\begin{ncolumn}{2} {\bf Mail:} 193 Main St \#1, Binghamton, NY 13905 & {\bf Phone:}\href{tel:12067908791}{+1 (206) 790-8791}
	\end{ncolumn}
}
\address{
	\begin{ncolumn}{2} {\bf Email:} \href{mailto:mcole8@binghamton.edu}{mcole8@binghamton.edu} & {\bf Web:} \url{https://colematt.github.io}
	\end{ncolumn}
}
...
\dates{Expected May 2021}
\begin{position}
\vspace*{-.2cm}
\begin{list2}
	\item Dissertation Topic: ``Enforcing Integrity Models on Tagged Architectures''
...
\dates{{\bf January 2018 \-- Present}}
\location{{\bf Binghamton, New York}}
\begin{position}
\vspace*{-.2cm}
\begin{list2}
...
\dates{{\bf August 2015 \-- December 2016}}
\begin{position}
\vspace*{-.2cm}
\begin{list2}
